...
//            switch sectionType {
//            case .one:
//                let cell = horizontalCollectionView.dequeueReusableCell(withReuseIdentifier: GeneralSectionNowCell.idGeneral1, for: indexPath) as! GeneralSectionNowCell
//                let arreyCollection = wheatherPhoto1[indexPath.item]
...
//                let arreyCollection = wheatherPhoto2[indexPath.item]
//                cell.configurationCellCollection(image: arreyCollection)
//                return cell
//            case .three:
...
//                let arreyCollection = wheatherPhoto3[indexPath.item]
//                cell.configurationCellCollection(image: arreyCollection)
//                return cell
//            }
//        }
