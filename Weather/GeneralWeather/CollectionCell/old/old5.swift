...
//    
//    
//    private lazy var layoutHorizontal: CustomCollectionViewFlowLayout = {
...
//
//        if collectionView == horizontalCollectionView  {
//            let cell = horizontalCollectionView.dequeueReusableCell(withReuseIdentifier: GeneralSectionDetailCell.idGeneral2, for: indexPath) as! GeneralSectionDetailCell
//            let arreyCollection = wheatherPhoto2[indexPath.row]
//            cell.configurationCellCollection(image: arreyCollection)
//            return cell
//        } else if collectionView == verticalCollectionView {
//            let cell = verticalCollectionView.dequeueReusableCell(withReuseIdentifier: GeneralSectionEveryDate.idGeneral3, for: indexPath) as! GeneralSectionEveryDate
...
//        if collectionView == horizontalCollectionView  {
//            let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: GeneralSectionDetailHeader.idGeneralHeader2, for: indexPath) as! GeneralSectionDetailHeader
//            return headerView
//        } else if collectionView == verticalCollectionView {
//            let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: GeneralSectionEveryDateHeader.idGeneralHeader3, for: indexPath) as! GeneralSectionEveryDateHeader
//            return headerView
//        }
...
//            let accessibleWidth = horizontalCollectionView.frame.width - 20
//            let widthItem = (accessibleWidth / countItem)
//            return CGSize(width: widthItem, height: 60)
//        } else if collectionView == verticalCollectionView {
//            let countItem: CGFloat = 1
//            let accessibleWidth = verticalCollectionView.frame.width - 20
//            let widthItem = (accessibleWidth / countItem)
